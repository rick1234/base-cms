@php
    ...
    $stylesheetUrl = null;
    $faviconSvgUrl = $activeDomain?->faviconUrl('svg');
    $faviconIcoUrl = $activeDomain?->faviconUrl('icon');
    $favicon16Url = $activeDomain?->faviconUrl('icon_16');
    $favicon32Url = $activeDomain?->faviconUrl('icon_32');
    $appleTouchIconUrl = $activeDomain?->faviconUrl('apple_touch_icon');
    $manifestUrl = $activeDomain?->faviconUrl('manifest');
    $maskIconUrl = $activeDomain?->faviconUrl('mask_icon');
    $browserConfigUrl = $activeDomain?->faviconUrl('browserconfig');
            ...
            <div class="wrapper-container">
                ...
                <div class="widgets-container">
                    <button class="btn-offscreen-navigation" type="button" aria-controls="site-offscreen-navigation" aria-expanded="false" data-site-menu-toggle>
                        <span class="site-material-icon admin-material-icon" aria-hidden="true">menu</span>
