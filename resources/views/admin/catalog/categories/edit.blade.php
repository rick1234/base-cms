    ...
    <div class="site-wrapper-container">
        ...
        <div class="main has-buttons">
            <div class="buttons-container align-right">
                <button class="btn btn-save" form="catalog-category-form" type="submit">
            ...
            <form id="catalog-category-form" method="post" action="{{ route($routeNames['save'], array_filter(['id' => $category->id])) }}">
                @csrf
