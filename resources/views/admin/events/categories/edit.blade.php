    ...
    <div class="site-wrapper-container">
        ...
        <div class="main has-buttons">
            <div class="buttons-container align-right">
                <button class="btn btn-save" form="event-category-form" type="submit">
            ...
            <form id="event-category-form" name="edit-form" enctype="multipart/form-data" method="post" action="{{ route($routeNames['save'], array_filter(['id' => $category->id])) }}">
                @csrf
