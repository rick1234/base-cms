        ...
        <div class="main has-buttons">
            <div class="buttons-container align-right">
                ...
                <a href="{{ route(request()->routeIs('cms.*') ? 'cms.translations.index' : 'admin.translations.index') }}" class="btn">
                    <x-admin.material-icon name="translate" />
                    {{ __('Translations') }}
                </a>
            ...
            <div class="main-section">
                ...
                <div class="language-summary-list">
                    ...
                    @empty
                        <span class="language-summary-item">{{ __('No website languages found.') }}</span>
                    @endforelse
                </div>
                ...
                <form id="language-settings-form" method="post" action="{{ route($routeNames['save-settings']) }}">
                    ...
                    <div class="overview-container languages-overview-container">
                        <div class="overview-row header">
                            ...
                            <div class="overview-item code">{{ __('Language') }}</div>
                        ...
                        @foreach ($languages as $language)
                            <div class="overview-row">
                                ...
                                <div class="overview-item code">
                                    <label for="enabled_language_{{ $language->id }}">
                                        <x-admin.language-flag :locale="$language->code" :label="$language->label()" />
                                    </label>
                                </div>
