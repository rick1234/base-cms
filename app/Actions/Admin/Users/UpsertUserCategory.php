...
class UpsertUserCategory
{
    /**
     * @param  array<string, mixed>  $data
     */
    public function handle(array $data, ?Authenticatable $actor = null, ?UserCategory $category = null): UserCategory
    {
        ...
        if (! $category->exists) {
            ...
            $attributes['sort_order'] ??= UserCategory::query()
