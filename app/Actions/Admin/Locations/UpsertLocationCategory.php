...
class UpsertLocationCategory
{
    /**
     * @param  array<string, mixed>  $data
     */
    public function handle(array $data, ?Authenticatable $actor = null, ?LocationCategory $category = null): LocationCategory
    {
        ...
        if (! $category->exists) {
            ...
            $attributes['sort_order'] ??= LocationCategory::query()
