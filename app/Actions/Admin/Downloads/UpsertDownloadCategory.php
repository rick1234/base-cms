...
class UpsertDownloadCategory
{
    /**
     * @param  array<string, mixed>  $data
     */
    public function handle(array $data, ?Authenticatable $actor = null, ?DownloadCategory $category = null): DownloadCategory
    {
        ...
        if (! $category->exists) {
            ...
            $attributes['sort_order'] ??= DownloadCategory::query()
