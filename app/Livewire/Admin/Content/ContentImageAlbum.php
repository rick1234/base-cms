...
class ContentImageAlbum extends Component
{
    use WithFileUploads;
    ...
    public function uploadImages(ContentMediaManager $mediaManager): void
    {
        $this->validate();
    ...
    public function deleteImage(int $imageId, ContentMediaManager $mediaManager): void
    {
    ...
    public function moveImage(int $targetImageId, ?int $draggedImageId = null, string $position = 'before'): void
    {
        ...
        app(ContentMediaManager::class)->updateSortOrder(ContentImage::class, $ids, auth()->user());
    ...
    {
        return view('livewire.admin.content.content-image-album', [
            'images' => $this->images(),
    ...
    private function findImage(int $imageId): ContentImage
    {
    ...
    /**
     * @return Collection<int, ContentImage>
     */
    ...
    private function editingImage(): ?ContentImage
    {
    ...
    private function syncImageForms(): void
    {
        $this->imageForms = $this->images()
            ->mapWithKeys(fn (ContentImage $image): array => [
                $image->id => [
