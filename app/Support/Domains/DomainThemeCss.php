...
class DomainThemeCss
{
    ...
    public function render(?Domain $domain): string
    {
        ...
        $variables = [
            '--color-brand' => $this->color($settings['primary_color'] ?? null, '#ffa300'),
            '--color-brand-strong' => $this->color($settings['secondary_color'] ?? null, '#272720'),
            '--color-tertiary' => $this->color($settings['tertiary_color'] ?? null, '#00a287'),
            '--color-accent' => $this->color($settings['accent_color'] ?? $settings['tertiary_color'] ?? null, '#ffa300'),
            '--color-surface' => $this->color($settings['surface_color'] ?? null, '#ffffff'),
            '--color-canvas' => $this->color($settings['canvas_color'] ?? null, '#ffffff'),
            '--color-light' => $this->color($settings['light_color'] ?? null, '#f0f0f0'),
            '--color-grey' => $this->color($settings['grey_color'] ?? null, '#e0e0e0'),
            '--color-dark' => $this->color($settings['dark_color'] ?? null, '#2d2d29'),
            '--color-ink' => $this->color($settings['ink_color'] ?? null, '#2d2d29'),
            '--color-ink-muted' => $this->color($settings['muted_ink_color'] ?? null, '#6f6f68'),
            '--font-body' => $baseFont,
