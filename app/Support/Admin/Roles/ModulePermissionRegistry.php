...
class ModulePermissionRegistry
{
    ...
    private function fieldsFor(string $moduleKey): array
    {
        $fields = [
            ...
            'catalog_products' => ['name', 'slug', 'description', 'pricing', 'status'],
            'catalog_categories' => ['name', 'slug', 'description', 'status'],
            'catalog_brands' => ['name', 'slug', 'description', 'website_url', 'logo_path', 'intro', 'body', 'meta_description', 'status'],
            'catalog_combination_sets' => ['name', 'description', 'products', 'status'],
