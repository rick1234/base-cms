...
class WmsModuleRegistry
{
    ...
    {
        return collect(config('wms.screens'))
    ...
    {
        $handle = config("wms.legacy_classes.$legacyClass");
    ...
    {
        return trim(str_replace('wms/', '', $definition['legacy_path']), '/');
    }
