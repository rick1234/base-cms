...
class LocationCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'id' => ['nullable', 'integer', 'exists:location_categories,id'],
            'parent_id' => ['nullable', 'integer', 'exists:location_categories,id'],
            'name' => ['required', 'string', 'max:255'],
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('location_categories', 'slug')->ignore($categoryId)],
    ...
    public function category(): ?LocationCategory
    {
        $id = $this->integer('id');
