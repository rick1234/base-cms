...
class VacancyCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'id' => ['nullable', 'integer', 'exists:vacancy_categories,id'],
            'parent_id' => ['nullable', 'integer', 'exists:vacancy_categories,id'],
            'name' => ['required', 'string', 'max:255'],
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('vacancy_categories', 'slug')->ignore($categoryId)],
    ...
    public function category(): ?VacancyCategory
    {
        $id = $this->integer('id');
