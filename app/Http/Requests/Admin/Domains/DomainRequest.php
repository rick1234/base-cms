...
class DomainRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'settings' => ['array'],
            'settings.seo' => ['array'],
            'settings.seo.locales' => ['array'],
            'settings.seo.locales.*.default_meta_title' => ['nullable', 'string', 'max:255'],
            'settings.seo.locales.*.default_meta_description' => ['nullable', 'string', 'max:500'],
            'settings.seo.locales.*.default_og_title' => ['nullable', 'string', 'max:255'],
            'settings.seo.locales.*.default_og_description' => ['nullable', 'string', 'max:500'],
            'settings.seo.locales.*.default_og_image' => ['nullable', 'string', 'max:255'],
    ...
    private function onlyRulesForStep(array $rules, string $step): array
    {
        $fields = match ($step) {
            ...
            'seo' => [
                ...
                'settings',
                'settings.seo',
                'settings.seo.locales',
                ...array_values(array_filter(
                    array_keys($rules),
                    fn (string $key): bool => str_starts_with($key, 'settings.seo.locales.'),
                )),
            ],
            'integrations' => [
                'public_integrations',
