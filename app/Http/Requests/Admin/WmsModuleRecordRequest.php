...
class WmsModuleRecordRequest extends FormRequest
{
     ...
     */
    public function rules(WmsModuleRegistry $modules): array
    {
     ...
     * @return array<string, mixed>
     */
    private function definition(WmsModuleRegistry $modules): array
    {
