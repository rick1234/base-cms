    ...
    public function run(): void
    {
        ...
        $defaultTemplate = WebsiteTemplate::query()->updateOrCreate(
            ...
            [
                ...
                'usp_sets' => [
                    [
                        'name' => 'Header trust bar',
                        'location' => 'header_top',
                        'items' => [
                            ['label' => 'Responsive maatwerk', 'icon' => 'done'],
                            ['label' => 'SEO vriendelijke basis', 'icon' => 'done'],
                            ['label' => 'Veilig en snel beheer', 'icon' => 'done'],
                        ],
                    ],
                    [
                        'name' => 'Footer reassurance',
                        'location' => 'footer_top',
                        'items' => [
                            ['label' => 'Laravel basis', 'icon' => 'code'],
                            ['label' => 'Meertalige content', 'icon' => 'translate'],
                            ['label' => 'Headless klaar', 'icon' => 'hub'],
                        ],
                    ],
                ],
                'is_active' => true,
