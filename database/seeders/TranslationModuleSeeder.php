...
class TranslationModuleSeeder extends Seeder
{
    ...
    public static function defaults(): array
    {
        $defaults = [
            ...
            'Catalog Combination Sets' => ['en' => 'Catalog Combination Sets', 'nl' => 'Catalogus combinatiesets'],
            'Catalog product options, combinations, translations, images, videos, and attachments.' => ['en' => 'Catalog product options, combinations, translations, images, videos, and attachments.', 'nl' => 'Catalogus productopties, combinaties, vertalingen, afbeeldingen, videos en bijlagen.'],
            ...
            'Combination set' => ['en' => 'Combination set', 'nl' => 'Combinatieset'],
            'Combination set deleted.' => ['en' => 'Combination set deleted.', 'nl' => 'Combinatieset verwijderd.'],
            'Combination set opslaan' => ['en' => 'Save combination set', 'nl' => 'Combinatieset opslaan'],
            'Combination set saved.' => ['en' => 'Combination set saved.', 'nl' => 'Combinatieset opgeslagen.'],
            'Combination set toevoegen' => ['en' => 'Add combination set', 'nl' => 'Combinatieset toevoegen'],
            'Combination sets' => ['en' => 'Combination sets', 'nl' => 'Combinatiesets'],
            ...
            'Products, categories, brands, media, videos, translations, and product options.' => ['en' => 'Products, categories, brands, media, videos, translations, and product options.', 'nl' => 'Producten, categorieen, merken, media, videos, vertalingen en product opties.'],
